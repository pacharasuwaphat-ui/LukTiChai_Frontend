            ...
            <div className="bg-[#070B2B] text-white rounded-xl w-full max-w-5xl p-10 shadow-xl mx-auto mt-30">
                ...
                <div className="text-sm text-gray-300 leading-relaxed space-y-3">
                    ...
                    <div className="flex items-baseline gap-2">
                        <p className="text-red-500 font-semibold">บุคคลิกตามวันเกิด</p>
                        <p>(วันที่ 1)</p>
                    </div>
                    <p>ผู้ที่เกิดวันที่ 1 มักมีความเป็นผู้นำในตัวเอง กล้าคิด กล้าตัดสินใจ มีความทะเยอทะยานแม้ภายนอกจะดูนิ่ง แต่ภายในมีความตั้งใจสูง</p>
                    <p className="text-red-500 font-bold mb-2">จุดแข็ง</p>
                    <ol className="list-none ml-5 space-y-1">
                        <li>- เข้าใจคนเก่ง</li>
                        <li>- มีความคิดสร้างสรรค์</li>
                        <li>- มีพลังผู้นำในตัว</li>
                    </ol>
                    <div className="flex items-baseline gap-2">
                        <p className="text-red-500 font-semibold">พลังตามเดือนเกิด</p>
                        <p>(ธันวาคม)</p>
                    </div>
                    <p>ธันวาคมเป็นพลังของการมองไกล ใฝ่รู้ รักอิสระ ชอบสิ่งใหม่ ไม่ชอบถูกจำกัดกรอบ</p>
                </div>
